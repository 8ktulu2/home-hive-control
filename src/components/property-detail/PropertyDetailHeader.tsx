    ...
    <div className="space-y-2">
      ...
      {historicalYear && (
        <Alert className="bg-yellow-50 border-yellow-200">
          ...
          <AlertDescription className="text-yellow-800 text-sm">
            <strong>Histórico {historicalYear}</strong> - Editando datos del año {historicalYear}
          </AlertDescription>
        </Alert>
      )}
      ...
      <div className={`flex justify-between items-start space-y-0 pb-2 ${
        ...
        <div className="flex flex-row gap-4 items-center">
          ...
          {/* ALWAYS show PropertyActions - but they should work in historical context when historicalYear is provided */}
          <PropertyActions 
