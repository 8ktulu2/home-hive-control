    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-medium truncate">Dirección</p>
          <p className="text-sm text-muted-foreground break-words">{property.address}</p>
        </div>
      </div>
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-medium truncate">Referencia Catastral</p>
          <p className="text-sm text-muted-foreground break-words">{property.cadastralReference || 'No especificada'}</p>
        </div>
      </div>
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-medium truncate">Metros cuadrados</p>
          <p className="text-sm text-muted-foreground break-words">
            {property.squareMeters ? `${property.squareMeters} m²` : 'No especificado'}
          </p>
        </div>
      </div>
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-medium truncate">Inquilinos</p>
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              {property.tenants.map(tenant => (
                <li key={tenant.id}>
                  <Button 
                    variant="link" 
                    className="p-0 h-auto text-sm text-muted-foreground hover:text-primary truncate max-w-full"
